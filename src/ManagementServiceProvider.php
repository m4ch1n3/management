<?php namespace Blupl\Management;
...
//        $this->app->bind('Orchestra\Control\Contracts\Command\Synchronizer', 'Orchestra\Control\Command\Synchronizer');
    ...
    public function boot()
    {
        ...
        $this->addConfigComponent('blupl/management', 'blupl/management', $path.'/resources/config');
        $this->addLanguageComponent('blupl/management', 'blupl/management', $path.'/resources/lang');
        $this->addViewComponent('blupl/management', 'blupl/management', $path.'/resources/views');
...
//    }
    ...
    {
        $this->app['events']->listen('orchestra.ready: admin', 'Blupl\Management\Http\Handlers\ManagementMenuHandler');
    }
    ...
    {
        $this->app['router']->filter('management.manage', 'Orchestra\Foundation\Http\Filters\CanManage');
...
//    }
    ...
    {
        $this->app['orchestra.extension.config']->map('blupl/management', [
